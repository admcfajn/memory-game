...
function buildVariants(num_variants, num_each_variant){
  variantList = [];
...
function assignVariant(elem, variant_list, num_variants){
...
function checkGameInput(theTotalVariants,theTotalCells){
